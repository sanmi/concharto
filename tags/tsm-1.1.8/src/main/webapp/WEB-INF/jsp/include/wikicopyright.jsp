...
<div class="infoBox">
	<p>
		Please note that all contributions to Concharto are considered to be released under the 
		Creative Commons Attribution-Share Alike 3.0 United States License (see  
		<a href="http://wiki.concharto.com/wiki/Legal#User_Submissions.">User Submissions Policy</a> for details). 
