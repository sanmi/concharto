...
*/        
    ...
    private Object transformToText(int m1, int d1, int y1, int hh1, int mm1, int ss1, 
        ...
        org.tsm.concharto.model.time.SimpleTimeRange timeRange = makeDayRange(m1, d1, y1, hh1, mm1, ss1, m2, d2, y2, hh2, mm2, ss2);
        return TimeRangeFormat.format(timeRange);
    }

    private org.tsm.concharto.model.time.SimpleTimeRange parseTimeRange(String text) throws ParseException {
    ...
    private void assertEquivalent(SimpleTimeRange expected, org.tsm.concharto.model.time.SimpleTimeRange actual) {
